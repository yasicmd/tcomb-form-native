  ...
  render() {
    ...
    return (
      <View style={[pickerContainer, (!this.state.isCollapsed) ? pickerContainerOpen : {}]}>
        <TouchableOpacity testID={locals.path[1]} style={[touchableStyle, { flexDirection: 'row', justifyContent: 'space-between', paddingRight: 10 }, this.state.isCollapsed ? {} : touchableStyleActive]}
          onPress={() => {
