  ...
  render() {
    ...
    return (
      <View style={[pickerContainer, (!this.state.isCollapsed) ? pickerContainerOpen : {}]}>
        <TouchableOpacity style={[touchableStyle,{flexDirection:'row',justifyContent:'space-between',paddingRight:10,fontFamily:'NotoSans-Bold'}, this.state.isCollapsed ? {} : touchableStyleActive]}
          onPress={() => {
          ...
          {(!this.state.isCollapsed)&&<Text style={{color:'#2a70d0',fontWeight:'bold'}}>Select</Text>}
        </TouchableOpacity>
